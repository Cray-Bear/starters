...
import com.fty1.orm.core.toolkit.sql.StringEscape;
import com.fty1.orm.core.toolkit.support.BiIntFunction;
...
public class StringUtils {
     ...
     *                   insensitive) or not.
     * @return <code>true</code> if the String test with the prefix or both
     * <code>null</code>
     * @see String#endsWith(String)
     */
