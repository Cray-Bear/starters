 ...
 * the License.
 */
package com.fty1.orm.test.base.mapper.commons;

import com.fty1.orm.annotation.SqlParser;
import com.fty1.orm.core.conditions.Wrapper;
import com.fty1.orm.core.metadata.IPage;
import com.fty1.orm.core.toolkit.Constants;
import com.fty1.orm.extension.plugins.pagination.Page;
import com.fty1.orm.test.base.entity.CommonData;
import com.fty1.orm.test.base.mapper.MyBaseMapper;
